module.exports = [
  {
    ...
    text: {
      intro: `
        ...
        ---
        It takes most people only about 20-40 minutes to learn Hangul, so let's get started!
      `
    },
    rounds: [
      {
        ...
        text: {
          intro: `
            It's time to learn how to read your first Korean word: Kimchi.
          `,
          letters: `
            ‘Kimchi’ is made up of 4 distinct sounds—‘k’, ‘m’, ‘ch’, and ‘i’. This means you need 4
            Hangul letters to write it.
            ---
            Notice that in Hangul, you only need 1 letter for the ‘ch’ sound, unlike in English which
            uses 2 letters. This will be the case with a lot of Hangul letters.
          `,
          word: `
